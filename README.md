# 🏗️ Engineering Hub
ศูนย์รวม Repository และโปรเจกต์ต่าง ๆ ของ itipunsnk-max — แยกตามหัวข้อเพื่อเรียกดูง่าย
...
- 🟢 [10.Pump-Water-Cleaning](https://github.com/itipunsnk-max/10.--Pump-Water-Cleaning) - แนวทางการออกแบบปั๊ม Water Cleaning งาน Solar Rooftop --> https://10-pump-water-cleaning-ceqwqrvjg-itthiphan.vercel.app/
...
- 🟢 [Supabase_LearningV.1](https://github.com/itipunsnk-max/Supabase_LearningV.1)- เรียนรู้การใช้ Supabase ---> https://supabase-learning-v-1.vercel.app/
...
- 🔴 [Inventory-POWER-BI_POWERAPPS.V2](https://github.com/itipunsnk-max/Inventory-POWER-BI_POWERAPPS.V2.git) (🚧 In Progress ) - ระบบ Inventory Management System Protoype V.2 (https://inventory-power-bi-powerapps-v2.vercel.app/)
